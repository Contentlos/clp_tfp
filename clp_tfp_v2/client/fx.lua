-- clp_tfp · client/fx — Partikel-FX + Sound (xsound) für SOTF-Juice
...
local GATHER = {
    tree  = { dict = 'core', name = 'ent_dst_wood',          sfx = 'chop' },
    rock  = { dict = 'core', name = 'ent_dst_concrete',      sfx = 'mine' },
    scrap = { dict = 'core', name = 'ent_dst_metal_chunks',  sfx = 'mine' },
    bush  = { dict = 'core', name = 'ent_dst_wood',          sfx = 'gather' },
    berry = { dict = 'core', name = 'ent_dst_wood',          sfx = 'gather' },
}
